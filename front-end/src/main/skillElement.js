...
export const skillNodes3 = [
  ...
  { id: '2', position: { x: 100, y: 300 }, data: { label: <SkillCard id={2}></SkillCard> } , type:'output'},
  { id: '3', position: { x: 500, y: 300 }, data: { label: <SkillCard id={3}></SkillCard> } , type:'output'},
  { id: '4', position: { x: 300, y: 500 }, data: { label: <SkillCard id={4}></SkillCard> }, type:'input' },
  { id: '5', position: { x: 100, y: 700 }, data: { label: <SkillCard id={5}></SkillCard> } , type:'output'},
  { id: '6', position: { x: 500, y: 700 }, data: { label: <SkillCard id={6}></SkillCard> } , type:'output'},
];
